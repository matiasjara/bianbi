...
export const pois: Poi[] = [
  ...
  },
  {
    ...
    slug: "metropolitan-santiago",
    category: "venue",
    lat: -33.4025,
    lng: -70.5785,
    influenceRadiusKm: 2.5,
    seasonality: "Congresos, ferias y MICE",
    description:
      "Centro de convenciones en Las Condes (Business Travel Expo, Expo Salud, Hyvolution).",
  },
  {
    id: "poi-espacio-riesco",
    name: "Espacio Riesco",
    slug: "espacio-riesco",
    category: "venue",
    lat: -33.383,
    lng: -70.621,
    influenceRadiusKm: 3,
    seasonality: "Ferias y exposiciones masivas",
    description:
      "Recinto ferial en Huechuraba (Edifica, Food & Service, Seguridad Expo).",
  },
  {
    id: "poi-centro-parque",
    name: "Centro Parque",
    slug: "centro-parque",
    category: "venue",
    lat: -33.4168,
    lng: -70.6068,
    influenceRadiusKm: 2,
    seasonality: "Congresos y eventos corporativos",
    description: "Centro de eventos en Providencia, junto a Costanera Center.",
  },
  {
